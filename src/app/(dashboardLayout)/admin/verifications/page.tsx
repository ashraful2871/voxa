...
const queue: User[] = [
    { id: 1, userName: "Mark Thompson", status: 'Pending', submitted: "Jul 8, 3:21 PM", type: "ID Verification" },
    {
        id: 2,
        userName: "Luther Logan",
        submitted: "Jul 8, 3:21 PM",
    ...
    },
    {
        id: 6,
        userName: "Mike Barlow",
        submitted: "Jul 6, 11:40 AM",
        type: "Income Verification",
        status: "Approved"
    },
    { id: 7, userName: "Mark Thompson", status: "Approved", submitted: "Jul 6, 11:40 AM", type: "ID Verification" },
    {
        id: 8,
        userName: "Yu Nakamura",
        submitted: "Jul 6, 11:40 AM",
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-border hover:bg-muted/50">
                                    ...
                                    <TableHead className="text-white text-end font-bold text-sm">Submitted</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {paginatedUsers.map((user) => (
                                    <TableRow key={user.id} className="border-border hover:bg-muted/50">
                                        ...
                                        <TableCell className="text-muted-foreground text-end">{user.submitted}</TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
